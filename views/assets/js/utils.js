...
async function getInfos(){
    disableButton(true)
    const usedCarsData = await fetch('assets/getAssetsRuning/'+sessionStorage.getItem('userAccount'));
    const usedCars = await usedCarsData.json();

    const totalCars = await fetch(`assets/allAssets/novarallywax/${sessionStorage.getItem('userAccount')}/`);
